...
const CameraControls: React.FC<CameraControlsProps> = ({
  ...
  // Determine if we're in landscape mode based on video dimensions
  const isLandscape = videoWidth && videoHeight && videoWidth > videoHeight;

  return (
    <div className="absolute inset-0 pointer-events-none">
      <div className={`absolute bottom-0 left-0 right-0 pb-8 pt-4 bg-gradient-to-t from-black/80 to-transparent pointer-events-auto ${isLandscape ? 'md:pb-4' : ''}`}>
